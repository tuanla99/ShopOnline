 ...
 * Generated at: 2019-12-10 00:30:54 UTC
...
public final class typenews_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  LoaiTinDAOImpl loaiTinDAO = new LoaiTinDAOImpl();
            ...
            ArrayList<TinTuc> arr = tinTucDAO.getListTinTucTheoLoaiTin(ma_loai_tin);
            int start = 0, end = 2;
            if (arr.size() < 2) {
                end = arr.size();
 ...
 for (LoaiTin loaitin : loaiTinDAO.getListLoaiTin()) {
  ...
  for (TinTuc tt : list) {
      ...
      out.write("\n");
      out.write("                            <li class=\"active\"><a href=\"typenews.jsp?ma_loai_tin=");
      out.print(ma_loai_tin );
      out.write("&start=");
      out.print(a);
      out.write("&end=");
      out.print(b);
